...
public class ProductData
{
    ...
    public Data_Layer3 data_layer { get; set; }
...
public class Product1
{
    ...
    public Data_Layer1 data_layer { get; set; }
...
public class Default_Variant1
{
    ...
    public Digiplus4 digiplus { get; set; }
...
{
    public Totally_Satisfied2 totally_satisfied { get; set; }
    public Satisfied2 satisfied { get; set; }
    public Neutral2 neutral { get; set; }
    public Dissatisfied2 dissatisfied { get; set; }
    public Totally_Dissatisfied2 totally_dissatisfied { get; set; }
    public int total_count { get; set; }
...
public class Product2
{
    ...
    public Default_Variant2 default_variant { get; set; }
}
...
public class Default_Variant2
{
    ...
    public Digiplus6 digiplus { get; set; }
    public Color4 color { get; set; }
    public Warranty3 warranty { get; set; }
    public Seller3 seller { get; set; }
    public Digiclub3 digiclub { get; set; }
    public Price3 price { get; set; }
    public Shipment_Methods3 shipment_methods { get; set; }
}

public class Statistics3
{
    public Totally_Satisfied3 totally_satisfied { get; set; }
    public Satisfied3 satisfied { get; set; }
    public Neutral3 neutral { get; set; }
    public Dissatisfied3 dissatisfied { get; set; }
    public Totally_Dissatisfied3 totally_dissatisfied { get; set; }
    public int total_count { get; set; }
    public float total_rate { get; set; }
}

public class Totally_Satisfied3
{
    public int rate_count { get; set; }
    public float rate { get; set; }
}

public class Satisfied3
{
    public int rate_count { get; set; }
    public float rate { get; set; }
}

public class Neutral3
{
    public int rate_count { get; set; }
    public float rate { get; set; }
}

public class Dissatisfied3
{
    public int rate_count { get; set; }
    public float rate { get; set; }
}

public class Totally_Dissatisfied3
{
    public int rate_count { get; set; }
    public float rate { get; set; }
}
...
public class Shipment_Methods3
{
    public string description { get; set; }
    public bool has_lead_time { get; set; }
    public Provider3[] providers { get; set; }
}
...
public class Detail
{
    ...
    public Product3[] products { get; set; }
}
...
public class Product3
{
    ...
    public int dimension15 { get; set; }
    public int metric15 { get; set; }
    public int metric11 { get; set; }
    public int metric12 { get; set; }
}
